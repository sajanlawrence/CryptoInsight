    ...
    var body: some View {
        ScrollView(.horizontal, showsIndicators: true) {
            HStack(spacing: 20) {
                ...
                CardView(title: "The date and time when the market cap ATH occurred", value: item.marketCapAthDate.toFormattedDate() ?? item.marketCapAthDate)
                ...
                CardView(title: "The date when ATH 24h volume occurred", value: item.volume24HAthDate.toFormattedDate() ?? item.volume24HAthDate)
